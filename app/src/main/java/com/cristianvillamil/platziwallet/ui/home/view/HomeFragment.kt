...
class HomeFragment : Fragment(), HomeContract.View{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homePresenter?.retrieveFavoriteTransfers() // optimizar con .let
    ...
    override fun showFavoriteTransfer(listFavoriteTransfer: List<FavoriteTransfer>) {
        favoriteTransferAdapter.setData(listFavoriteTransfer)
    }
}